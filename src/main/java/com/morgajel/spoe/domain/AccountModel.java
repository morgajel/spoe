...
public  class AccountModel implements Comparable<AccountModel>, Serializable {
    ...
    /**
     * Returns this lastAccessDate date as a localized string.
     */
    @Transient
    public String getLocalizedLastAccessDate() {
        return ResourcesUtil.getFormattedDate(getLastAccessDate());
    }
    ...
    /**
     * Returns this creationDate date as a localized string.
     */
    @Transient
    public String getLocalizedCreationDate() {
        return ResourcesUtil.getFormattedDate(getCreationDate());
    }
    ...
    public String toString() {
        ...
        if (isLastAccessDateSet()) {
            ret.append("account.last_access_date=[").append(getLocalizedLastAccessDate()).append("]\n");
        }
        if (isCreationDateSet()) {
            ret.append("account.creation_date=[").append(getLocalizedCreationDate()).append("]\n");
        }
        if (isRoleIdSet()) {
