...
package com.morgajel.spoe.context;
...
public class AccountContext {
    ...
    /**
     * Return the AccountModel instance bound to the current thread, if any.
     *
    ...
    /**
     * Tell whether the passed account is the same as the AccountModel
     ...
     */
    public boolean isAccount(AccountModel account) {
        if (this.account != null &&
                this.account.isAccountIdSet() &&
                account != null) {
            return this.account.getAccountId().equals(account.getAccountId());
        }
